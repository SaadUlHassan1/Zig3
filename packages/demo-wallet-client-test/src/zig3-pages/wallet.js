                    ...
                    <div className="wallet">
                      <div className='row w-100 mb-5'>
                        <div className='p-4 pt-0 w-100'>
                          <h1 className='font-weight-bold mt-3'>Zig3</h1>
                          <h3 className='font-weight-bold mt-2'>Your public key :</h3>
                          <p className='mt-3 mb-4 font-weight-bold'>"{keys.publicKey}"</p>
                          <h3 className='font-weight-bold mt-2'>Your balance:</h3>
                          <p>Your account is not activated yet . Activate your account by putting 5 XLM in it.</p>
                          <table className="table">
                            <thead className="thead-light">
                              <tr>
                                <th scope="col">asset logo</th>
