...
import { Sep9Field } from "demo-wallet-shared/Sep9Fields";
declare module '*.jpg';
declare module '*.png';
...
export enum ModalType {
  SIGNIN_FINGER_FACE = "SIGNIN_FINGER_FACE",
...
export interface Store {
  ...
  walletRabet: WalletInitialState;
...
export interface ClaimableAsset extends Asset {
  asset(asset: any): string | undefined;
  id: string;
  sponsor: string;
