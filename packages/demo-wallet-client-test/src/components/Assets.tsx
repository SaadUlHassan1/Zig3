    ...
    <>
      ...
      <div className="Section">
        <Layout.Inset>
          ...
          <div className='Balances_table_header' style={{display: 'flex', justifyContent: 'center', width: '90%', padding: '6px 6px 0px 6px', backgroundColor: '#e6edf4'}}>
            <div style={{display: 'flex', width: '96%'}}>
              <div style={{width: '17%'}}>
                <Heading5>Asset Logo</Heading5>
              </div>
              <div style={{width: '20%'}}>
                <Heading5>Asset Code</Heading5>
              </div>
              <div style={{width: '20%'}}>
                <Heading5>Issuer</Heading5>
              </div>
              <div style={{width: '20%'}}>
                <Heading5>Balance</Heading5>
              </div>
              <div style={{width: '23%'}}>
                <Heading5>Send Payment Type</Heading5>
              </div>
            </div>
          </div>
        </div>
