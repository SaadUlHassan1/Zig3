...
import { Identicon, CopyText, TextLink } from "@stellar/design-system";
import { useRedux } from "hooks/useRedux";
import { connect } from "react-redux";
import "@stellar/design-system/build/styles.min.css";
class HeaderZig extends React.Component {
  ...
  const isSignedIn = account?.isAuthenticated && account?.data?.id;
    return (
      <div className="container-fluid">
        <header className="light-bb">
          <Navbar expand="lg">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="navbar-nav mr-auto">
                ...
                <Link to="/dx-exchange" className="nav-link">
                  DX Exchange
                </Link>
                <Link to="/stellar-markets" className="nav-link">
                  Stellar Markets
                </Link>
          ...
          {isSignedIn ? <><div className="Header__account">
            <CopyText
              textToCopy={account?.data?.id}
              showCopyIcon
              showTooltip
            ...
            >
              <Identicon
                publicAddress={account?.data?.id}
                shortenAddress
              />
            </CopyText>
          </div>
          <TextLink href="/login" variant={"secondary"} underline>
            Sign out
          </TextLink>
          <ThemeConsumer>
            {({ data, update }) => (
              <Button variant="default" onClick={() => this.toggleTheme(update)} id="darkTheme">
                {data.theme === "light" ? (
                  ...
                  <Dropdown.Menu>
                    ...
                    <div className="dropdown-body">
                      <ul className="profile-nav">
                        ...
                        <li className="nav-item">
                          {isSignedIn ? <Link to="/login" className="nav-link red">
...
export default connect(mapStateToProps)(HeaderZig);
