...
import { HomeDomainOverrideButtons } from "./HomeDomainOverrideButtons";
  ...
  return (
    ...
    >
      <div className="BalanceCell">
        <div className="BalanceAmount"><img src={assetImage || 'img/stellar-xlm-logo.png'} alt={assetString || 'asjd'} width='30'/></div>
      </div>
      <div className="BalanceCell">
        <div className="BalanceAmount">{`${assetCode}`}</div>
      </div>
      <div className="BalanceCell" style={{width: '10%', overflow: 'auto'}}>
        <div className="BalanceAmount">{`${assetIssuer || 'Native'}`}</div>
      </div>
      ...
      <div className="BalanceCell BalanceActions">
        {children && <div className="CustomCell">{children as any}</div>}
